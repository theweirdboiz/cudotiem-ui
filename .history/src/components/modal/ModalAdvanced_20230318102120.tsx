...
const ModalAdvanced: React.FunctionComponent<ModalAdvancedProps> = (props) => {
  const { children, heading, handleClose, visible } = props;
  return (
    <ModalBase handleClose={handleClose} visible={visible}>
      <span
      ...
      <h2 className="pb-5 text-4xl font-medium text-center text-black bg-white rounded-t-lg">
        {heading}
      </h2>
      {children}
    </ModalBase>
