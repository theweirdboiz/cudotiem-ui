...
const Dropdown = ({
  ...
  return (
    <div className="relative" ref={dom}>
      <div
        className="flex items-center justify-between p-4 bg-white border border-blue-400 text-gray-500 font-medium text-sm  rounded-xl cursor-pointer"
      ...
      >
        {data &&
          data.map((item) => (
            <div
              className="p-5 cursor-pointer border-b hover:bg-blue-100"
