...
const Sidebar = (props: Props) => {
  return (
    <aside className="w-[210px] max-h-screen sticky overflow-y-scroll top-4 bg-transparent flex flex-col text-gray-800 text-[14px] scrollbar-hide bg-white rounded-lg">
