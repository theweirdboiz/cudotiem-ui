      ...
      <div className="w-[1280px] px-6 mx-auto">
        ...
        <div className="flex-center">
          ...
          <div className="flex-center ml-12 text-gray-500 font-normal">
            ...
            <div className="flex-center px-4 py-2 cursor-pointer rounded-lg hover:bg-gray-200 relative group-item">
              <img
              ...
              <div className="hidden group-hover/item:block absolute w-60 z-10 py-2.5 shadow-lg left-0 top-[38px] rounded-lg bg-white text-gray-700 -translate-x-1/2 border border-gray-200">
