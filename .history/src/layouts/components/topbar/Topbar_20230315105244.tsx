          ...
          <div className="flex items-center">
            ...
            <div>
              <div className="flex items-center border border-gray-200 rounded-lg">
                ...
                />
                <button
                  className="flex items-center justify-center w-24 h-9 bg-transparent text-blue-600 p-1 text-[14px] relative after:content-['']  after:absolute after:border-l after:border-l-gray-200 after:left-0 after:top-2 after:h-5 hover:bg-current hover:bg-opacity-5
                "
                >
                  Tìm kiếm
                </button>
