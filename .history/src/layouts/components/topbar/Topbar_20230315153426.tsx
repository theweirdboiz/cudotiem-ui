  ...
  return (
    <header className="py-2 text-[14px]">
      <div className="w-[1280px] px-6 mx-auto">
        ...
        {/* header bottom */}
        <div className="flex-center-betweeen">
          {/* left */}
          <div className="flex items-start ml-[105px] mt-2">
            <Link to="/thoi-trang/pants" className="mr-3 text-gray-500">
              Quần
            </Link>
            <Link to="/thoi-trang/pants">Áo</Link>
          </div>
          {/* right */}
          <div className=""></div>
        </div>
