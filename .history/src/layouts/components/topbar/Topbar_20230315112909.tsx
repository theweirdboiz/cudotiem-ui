      ...
      <div className="w-[1280px] px-6 mx-auto">
        <div className="flex-center">
          ...
          <div className="flex-center ml-12 text-gray-500 font-normal">
            <div className="flex-center px-4 py-2 cursor-pointer rounded-lg hover:bg-current hover:bg-opacity-10">
              <img
            ...
            <div className="flex-center px-4 py-2 cursor-pointer rounded-lg">
              <img
