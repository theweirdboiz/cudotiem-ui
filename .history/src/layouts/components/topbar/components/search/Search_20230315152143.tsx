...
function Search({}: Props) {
  ...
  "
      ...
      <div className="absolute w-full left-0 top-[calc(100%_-_1px)] rounded-t-lg shadow-md h-20">
        <div className="">
          <Link to="/search?q=keyword" className="flex-center px-4">
            <img
              src="https://salt.tikicdn.com/ts/upload/e8/aa/26/42a11360f906c4e769a0ff144d04bfe1.png"
              alt="search-icon"
              className="w-[35px] h-[35px]"
            />
            <p className="flex-1">Muôn kiếp nhân sinh</p>
          </Link>
        </div>
      </div>
    </div>
