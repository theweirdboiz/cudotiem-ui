      ...
      <div className="w-[1280px] px-6 mx-auto">
        ...
        <div className="flex-center">
          ...
          <div className="flex-center ml-12 text-gray-500 font-normal">
            ...
            <div className="flex-center px-4 py-2 cursor-pointer rounded-lg hover:bg-gray-300 relative">
              <img
              ...
              <div className="absolute w-60 z-10 py-2.5 shadow-lg left-0 top-[38px] rounded-lg bg-white text-gray-700 -translate-x-1/2">
                <a href="/customer/account" className="hover:bg-gray-400">
                  <p className="py-2 px-4">Thông tin tài khoản</p>
                </a>
                <a href="/customer/account">
                  <p className="py-2 px-4">Đơn hàng của tôi</p>
                </a>
                <a href="/customer/account">
                  <p className="py-2 px-4">Tin đăng của tôi</p>
                </a>
                <a href="/customer/account">
                  <p className="py-2 px-4">Đăng xuất</p>
                </a>
              </div>
            </div>
            {/* cart */}
