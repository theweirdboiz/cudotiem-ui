          ...
          <div className="flex-center ml-12 text-gray-500 font-normal">
            ...
            <div className="flex-center px-4 py-2 cursor-pointer">
              <Link to="/checkout/cart">
                <div className="box-center ml-6 relative after:absolute after:content-[''] after:h-5 -left-3 border border-gray-200">
                  <div className="box-center w-10 h-10 relative">
                    <img
                      ...
                      className="w-6 h-6"
                    />
                    <span className="absolute bg-red-500 rounded-lg inline-block right-0 -top-1 px-[3.5px] py-[0.5px] text-xs text-white">
                      0
                    </span>
                  </div>
                </div>
